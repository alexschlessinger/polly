...
func ChildRegistry(parent *tools.ToolRegistry, allow []string) *tools.ToolRegistry {
	opts := []tools.DeriveOption{tools.DenyTools(ToolName, "set_session_title", "swarm_*", "workflow_*", "list_agents", "send_message", "read_messages", "followup_task", "interrupt_agent", "wait_agent")}
