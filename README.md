...
children add `swarm_complete`. [WORKFLOWS.md](WORKFLOWS.md) lists them. Use the
listed next action; while work progresses, the parent waits for events.
...
same runtime. See [WORKFLOWS.md](WORKFLOWS.md) for the start/wait/finish
patterns.
