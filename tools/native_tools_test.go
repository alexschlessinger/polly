...
func TestDeriveCopiesSandboxStateWithoutPreparing(t *testing.T) {
	...
	if !view.HasSandbox() || !view.baseSandboxPrepared {
		t.Fatal("derivation dropped the prepared sandbox state")
	}
}
